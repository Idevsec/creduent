...
```json
{
  ...
  "agent_id": "agent://example/mybot",
  "webhook_url": "https://example.com/hooks/creduent",
  "webhook_secret": "whsec_8f3a2b1c...9e0d"
}
```
*Note:* The `webhook_secret` is a pre-shared key generated by the registry used to verify HMAC-SHA256 signatures sent in webhook delivery headers.
...
| Version | Date | Notes |
|:---|:---|:---|
| 0.5 | 2026-07-20 | Added webhook_secret response parameter to POST /webhook/register and documented X-Creduent-Signature256 header verification. |
